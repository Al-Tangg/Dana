...
| 카테고리               | 제목                       | 문제 풀이 링크     | 날짜     | 시간 내 풀었는가?
|----------------------|---------------------------|-----------------|---------|---------|
| 힙 | [프로그래머스: 디스크 컨트롤러]| (<a href = "스택,큐.힙/디스크컨트롤러.py">🔗<a/>) | 24.10.07 | ❌
| 투포인터 | [백준: 대표선수]| (<a href = "">🔗<a/>) | 24.10.07 | 
| DFS+BFS | [백준: 빙산]| (<a href = "완전탐색/DFS+BFS 필수문제(백준)/빙산.py">🔗<a/>) | 24.10.07 | ❌
| DFS+BFS | [백준: 안전영역]| (<a href = "완전탐색/DFS+BFS 필수문제(백준)/안전영역.py">🔗<a/>) | 24.10.08 | ✅
| 카카오 | [프로그래머스: 문자열압축]| (<a href = "카카오(프로그래머스)/lv2/문자열 압축.py">🔗<a/>) | 24.10.08 | ✅
| BFS | [백준: 숨바꼭질3]| (<a href = "완전탐색/BFS/숨바꼭질3.py">🔗<a/>) | 24.10.09 | ✅
| 2020 카카오 인턴십 | [프로그래머스: 경주로 건설] | (<a href = "완전탐색/BFS/숨바꼭질3.py">🔗<a/>) | 24.10.09 | ✅
| 대기업 코테 | [백준: 탑]| (<a href = 스택,큐.힙/탑.py">🔗<a/>) | 24.10.10 | 
| 대기업 코테 | [백준: 빗물]| (<a href = "구현, 시뮬/빗물.py">🔗<a/>) | 24.10.10 | 
| 대기업 코테 | [백준: 용액]| (<a href = "투포인터/용액.py">🔗<a/>) | 24.10.10 | 
| BFS | [백준: 상범 빌딩]| (<a href = "">🔗<a/>) | 24.10.10 | 
| 그리디 | [프로그래머스: 조이스틱]| (<a href = "">🔗<a/>) | 24.10.08 | 
